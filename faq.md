...
binary, and the Dart framework which ships as a separate binary that the engine loads. 
The engine uses a lot of code with a wide variety of licenses; view the complete list 
[here](https://raw.githubusercontent.com/flutter/engine/master/sky/packages/sky_engine/LICENSE).
